...
def slide_window(binary_warped):
    ...
    for window in range(nwindows):
        ...
        # If found indices > minpix pixels, recenter next window on their mean position
    ...
    # ax1.set_title('Binary warped', fontsize=10)
    #
    # ax2.imshow(out_img)
    # ax2.set_title('Sliding window histogram', fontsize=10)
    ...
    # plt.ylim(720, 0)
    # plt.show()
    return leftx, rightx, left_fit, right_fit, left_fitx, right_fitx, ploty

def skip_slide_window(binary_warped, left_fit, right_fit):
